...
function PulseBar({ color = T.accent }: { color?: string }) {
  return (
...
function SupplierCard({ s, onChat, compact }: { s: Supplier; onChat?: () => void; compact?: boolean }) {
  return (
...
// ── AUTH: LOGIN ───────────────────────────────────────────────────────────────
function LoginPage({ setPage, showToast }: { setPage: (p: string) => void; showToast: (m: string) => void }) {
...
// ── AUTH: REGISTER ────────────────────────────────────────────────────────────
function RegisterPage({ setPage, showToast }: { setPage: (p: string) => void; showToast: (m: string) => void }) {
...
// ── HOME ──────────────────────────────────────────────────────────────────────
function HomePage({ setPage, setRfq, setChat }: { setPage: (p: string) => void; setRfq: (v: boolean) => void; setChat: (v: boolean) => void }) {
  return (
...
// ── SUPPLIERS ─────────────────────────────────────────────────────────────────
function SuppliersPage({ setChat }: { setChat: (v: boolean) => void }) {
...
// ── CATEGORIES ────────────────────────────────────────────────────────────────
function CategoriesPage({ setPage }: { setPage: (p: string) => void }) {
  return (
    <div className="pscroll aFadeUp" style={{ padding:"0 16px" }}>
...
// ── RFQ PAGE ──────────────────────────────────────────────────────────────────
function RFQPage({ showToast }: { showToast: (m: string) => void }) {
  const rfqs = [
...
// ── DASHBOARD ─────────────────────────────────────────────────────────────────
function DashboardPage({ showToast }: { showToast: (m: string) => void }) {
...
// ── CHAT WIDGET ───────────────────────────────────────────────────────────────
interface ChatMsg { from: string; text: string; }
...
// ── RFQ SHEET ─────────────────────────────────────────────────────────────────
function RFQSheet({ open, onClose, showToast }: { open: boolean; onClose: () => void; showToast: (m: string) => void }) {
  if (!open) return null;
  return (
